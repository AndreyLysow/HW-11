...
function timeToBday(){
  ...
  printf("Осталось %d месяцев, %d дней, %d часов, "
       . "%d минут, %d  секунд до Вашего дня рождения и специальной акции в честь этой даты!", $months,
               $days, $hours, $minutes, $seconds);
  } else if( ($diff > -86400) && ($diff < 0) ) {
    echo '<span style="text-transform: uppercase;" >С днём рождения, '.$_SESSION['login'].'!</span> Поздравляем! Имениннику дарим дополнительную скидку в 5% на все услуги салона!';
